...
import com.ecommerce.codeshop.model.*;
import com.ecommerce.codeshop.repository.*;
...
public class OrderController {
    ...
    public String createOrder(@RequestParam long customerId, @RequestParam List<CheckoutOrder> checkoutOrders, @RequestParam String shippingAddress){
        ...
        Payment payment = new Payment();    paymentRepository.save(payment);    //Create New payment and save it...
